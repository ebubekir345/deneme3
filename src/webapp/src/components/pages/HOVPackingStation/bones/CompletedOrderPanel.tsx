...
import { PackageType, ReprintHOVPalettePackingListCommand } from '../../../../services/swagger';
...
const CompletedOrderPanel: React.FC = () => {
  ...
  const reprintHOVPalettePackingListResponse: Resource<ReprintHOVPalettePackingListCommand> = useSelector(
            ...
            {packingState.boxItems.some(boxItem => boxItem.type === PackageType.Palette) && (
              ...
              >
                ...
                <Button
                  onClick={() => {
                    dispatch(
                      resourceActions.resourceRequested(ResourceType.ReprintHOVPalettePackingList, {
                        payload: { salesOrderId: packingState.orderId },
                      })
                    );
                  }}
                  disabled={reprintHOVPalettePackingListResponse?.isBusy}
                  width={60}
                  height={60}
                  borderRadius="lg"
                  boxShadow={
