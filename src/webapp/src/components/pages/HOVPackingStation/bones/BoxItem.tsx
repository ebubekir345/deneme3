...
import { PackageType, PrintHOVPalettePackingListCommand } from '../../../../services/swagger';
...
const BoxItem: React.FC<BoxItemProps> = ({ boxItem, boxItemListRef, bottomButtonGroupRef }): ReactElement => {
  ...
  const printHOVPalettePackingListResponse: Resource<PrintHOVPalettePackingListCommand> = useSelector(
    (state: StoreState) => state.resources[ResourceType.PrintHOVPalettePackingList]
  );

  const onPrintPalette = (boxItem: BoxItemsInterface) => {
    dispatch(
      resourceActions.resourceRequested(ResourceType.PrintHOVPalettePackingList, {
        params: {
        ...
        >
          ...
          {boxItem.type === PackageType.Palette && (
            <Button
              ...
              borderStyle="solid"
              borderColor={
                !printHOVPalettePackingListResponse?.isBusy &&
              ...
              letterSpacing="large"
              borderRadius="lg"
              disabled={!boxItem.content.length || printHOVPalettePackingListResponse?.isBusy}
              _focus={{
                outline: 'none',
              }}
              _hover={{
