...
import { initialHovPackingState, IHovPackingStore } from '../../../../../store/global/hovPackingStore';
import { ProgressBar } from '../../../../atoms/TouchScreen';

let mockPackingState: IHovPackingStore;
...
describe('OrderItem', () => {
  beforeEach(() => {
    mockPackingState = { ...initialHovPackingState };
    mockProduct = {
      productId: '111',
