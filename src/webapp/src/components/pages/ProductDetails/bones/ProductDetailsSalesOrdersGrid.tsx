...
import { FilterIds, FilterProperties } from '../../DispatchManagement/bones/PredefinedFilters';
import { DeliveryTypeColors } from '../../PickingManagement/bones/PickingManagementWaitingOrdersGrid';

const intlKey = 'ProductDetails.ProductDetailsSalesOrders';
const titleKey = 'ProductDetails.ProductDetailsSalesOrders.Title';
const productDetailsSalesOrdersGridPredefinedFilters: PredefinedFilter[] = [
  {
...
export interface IProductDetailsSalesOrdersGrid {
  productIdFromRoute: string;
}

const ProductDetailsSalesOrdersGrid: React.FC<IProductDetailsSalesOrdersGrid> = ({ productIdFromRoute }) => {
  const { t } = useTranslation();
  const ProductDetailsSalesOrderGridColumns: Array<any> = [
    {
  ...
  return (
    <GenericDataGrid
      titleKey={t(titleKey)}
      intlKey={intlKey}
      gridKey={GridType.SalesOrdersProductDetail}
      columns={ProductDetailsSalesOrderGridColumns}
      predefinedFilters={productDetailsSalesOrdersGridPredefinedFilters}
      apiArgs={[productIdFromRoute]}
    />
  );
};

export default ProductDetailsSalesOrdersGrid;
