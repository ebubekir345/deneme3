...
const intlKey = 'WarehouseManagement.CellContainersGrid';
const titleKey = 'WarehouseManagement.CellContainersGrid.Title';
...
const CellContainersGrid: React.FC = () => {
  ...
  return (
    <GenericDataGrid
      titleKey={t(titleKey)}
      intlKey={intlKey}
      gridKey={GridType.CellContainers}
...
export default CellContainersGrid;
