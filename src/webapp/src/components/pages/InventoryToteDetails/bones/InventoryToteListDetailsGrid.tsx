...
interface IInventoryToteListDetailsGrid {
  toteLabel: string;
}

const InventoryToteListDetailsGrid: React.FC<IInventoryToteListDetailsGrid> = ({ toteLabel }) => {
...
export default InventoryToteListDetailsGrid;
