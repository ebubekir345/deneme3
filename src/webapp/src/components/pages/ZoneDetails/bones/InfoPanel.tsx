            ...
            <Flex flexDirection="column" mr={100} key={i.toString()} width={300} minWidth={300}>
              {isBusy ? (
                ...
                <>
                  ...
                  <Text fontSize={16} fontFamily="Montserrat" fontWeight={700} color="#707070" textOverflow="ellipsis" overflow="hidden" whiteSpace="nowrap" maxWidth={300}>
                    {data.key}
                  </Text>
                </>
              )}
            ...
            <Flex flexDirection="column" mr={100} key={i.toString()} width={300} minWidth={300}>
              {isBusy ? (
                ...
                <>
                  ...
                  <Text fontSize={16} fontFamily="Montserrat" fontWeight={700} color="#707070">
                    {data.key}
                  </Text>
                </>
              )}
