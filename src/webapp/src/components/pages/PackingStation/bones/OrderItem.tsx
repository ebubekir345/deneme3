...
const OrderItem: React.FC<OrderItemProps> = ({ product, onImageClicked, iconsVisible }): ReactElement => {
    ...
    >
      ...
      >
              ...
              <Flex alignItems="center" justifyContent="space-between">
                {product.barcodes?.length && (
                  <Flex
                    ...
                    py={11}
                    width={packingState.modals?.AddSerialNumber ? '35vmin' : product?.productTags ? '45vmin' : '65vmin'}
        ...
        <Box
          ...
          whiteSpace="nowrap"
        >
          {`${!product.isMissingItem ? `${product.boxedCount} / ` : ''}${product.amountInOrder}`}
        </Box>
      </Flex>
    </Box>
  );
