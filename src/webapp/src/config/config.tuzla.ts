...
export const config: Partial<Config> = {
  api: {
    url: 'https://maestro-api.oplog.cloud/tuzla',
  ...
  auth: {
    ...
    logout_uri: 'https://maestro-tuzla.oplog.app/login',
    domain: 'oplog-maestro.eu.auth0.com',
    client_id: 'nfdVpyW4pu9VecM4cvyuaCX2gIR6HNS7',
    redirect_uri: 'https://maestro-tuzla.oplog.app/callback',
    audience: 'https://maestro-web.azurewebsites.net',
    scope: 'openid email profile',
    leeway: 30,
  },
  elastic: {
    serviceName: 'Maestro WebApp Tuzla',
